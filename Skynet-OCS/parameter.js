let mod = {
    ...
    TIME_ZONE: -5, // zone offset in hours (-12 through +12) from UTC
    ...
    REMOTE_HAULER_MULTIPLIER: 2, // Max number of haulers spawned per source in a remote mining room.
